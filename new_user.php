		...
		<form class="center_form" action="new_user_form_handler.php" method="POST" id="new_user_from">
			...
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="password" name="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,}" oninvalid="this.setCustomValidity('Must contain atleast 1 Uppercase letter, 1 Lowercase letter, and minimum of 10 characters')"
    oninput="this.setCustomValidity('')"  /><br><br></td>
				</tr>
				<tr>
