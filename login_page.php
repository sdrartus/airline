	...
	<img class="logo1" src="flightlylogo.jpg"/> 
		...
		<form class="float_form" style="padding-left: 37%" action="login_handler.php" method="POST">
			<fieldset>
				...
				<input type="password" name="password" class="text" placeholder="Enter your password" required><br><br> <!-- pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,}" -->
				...
				<br>
				<div class="g-recaptcha" data-sitekey="6LcJ3ZgeAAAAABgI3SEO_LInpFGWZ8Dn2V1rKpeA"></div>
				<?php
